  ...
  return (
    <div className="App">
      <header className="App-header">
        <h2>Manage Your Solana Wallet</h2>
        <div className="button-container">
          <button className="custom-button" onClick={createWallet}>
            Create a New Solana Account
          </button>
          <button className="custom-button" onClick={connectWallet}>
            Connect Wallet
          </button>
          <button className="custom-button" onClick={transferToWallet}>
            Transfer SOL to My Wallet
          </button>
          <button className="custom-button" onClick={getWalletBalance}>
            Check Account Balance
          </button>
        </div>
        {connected && <p>Connected to your Solana account</p>}
        {message && <p>{message}</p>}
      </header>
    </div>
  );
